...
```
# paste the request verb and URL here
https://maps.googleapis.com/maps/api/directions/json?origin=place_id:ChIJRRI8walZwokRCPoUQ0TSCoQ&destination=place_id:ChIJb8Jg9pZYwokR-qHGtvSkLzs&key=AIzaSyBY_p65zSyoiIcnrd6e-LnPTfDUNGUUjxU
...
```
# paste the request verb and URL here
https://maps.googleapis.com/maps/api/directions/json?origin=Oakland,CA&destination=Brooklyn,NY&key=AIzaSyBY_p65zSyoiIcnrd6e-LnPTfDUNGUUjxU
```
```
# paste the response data here
{
...
```
# paste the request verb and URL here
https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=place_id:ChIJRRI8walZwokRCPoUQ0TSCoQ&destinations=place_id:ChIJb8Jg9pZYwokR-qHGtvSkLzs&key=AIzaSyBY_p65zSyoiIcnrd6e-LnPTfDUNGUUjxU
...
```
# paste the request verb and URL here
https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=Oakland,CA&destinations=Brooklyn,NY&key=AIzaSyBY_p65zSyoiIcnrd6e-LnPTfDUNGUUjxU
```
```
# paste the response data here
{
