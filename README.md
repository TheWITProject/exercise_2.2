...
```
GET https://maps.googleapis.com/maps/api/directions/json?origin=place_id:ChIJRRI8walZwokRCPoUQ0TSCoQ&destination=place_id:ChIJb8Jg9pZYwokR-qHGtvSkLzs&key=AIzaSyB_qbjwcLagyna7J6zK7Y3s0NErk90I360
```
```
{
    "geocoded_waypoints": [
...
```
GET https://maps.googleapis.com/maps/api/directions/json?origin=place_id:ChIJA-2qKIt9hYARZ5N1NdUVtHE&destination=place_id:ChIJCSF8lBZEwokRhngABHRcdoI&key=AIzaSyB_qbjwcLagyna7J6zK7Y3s0NErk90I360
```
```
{
    "geocoded_waypoints": [
    ...
    "routes": [
        {
            ...
            "legs": [
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "maneuver": "merge",
                            "polyline": {
                                "points": "cyswFdf`cM@EFYDUDUFUH[HYHUXw@Zu@NYJUHQDGHOLSBEPW@CLMbAoAxD{ElB}Br@}@t@_AZ_@t@}@dC}CxAeBxAeB^e@`@g@NSrB{Bb@i@b@i@NOHKLQNSV]LUFKFKDIDIFMDIDKDIDMDOBKBKDODSBOBM@QBO@M@M@K@Q?S@Y@eABmA\\uJB_@@_@DiAHgBHqB@]B_@?EJmCB_@HcAB_@BUDK@EBIFI?UBi@Bk@Dq@?AJwB?K@W@YDmABc@?G@[@MDy@@Q@U@QHeABOFo@D[@QBY@YDs@Be@"
                            },
                            "start_location": {
                                "lat": 40.7389048,
                                "lng": -74.0619512
            ...
            "overview_polyline": {
                "points": "etveFtahiVswSl~GadOebBaaOqsLgzZgwQqn_@eoe@ks\\sve@edLyfe@w{N_bh@ork@mjs@}lWu`QgoRaeIwwH_~QwsZ}am@tEosbAa_H_z`@{tDoiGihOwbE}oHmgc@brCugYulFm|R{xFahd@yuC{eYa{Vuac@ukTeqW{lUcml@clWscRoySww]yxa@s|Zg}n@kiMa{Oeyb@_a`@khTa`IeyVmoLib[c~DavPvcHayHlyI}_YbsEoqVjlc@mzr@xsP_gc@abKm~a@pa@_le@l}CejWy}N{`k@n}@kyUioLgqTom[gff@elE}hi@q|LeoNixLysnApcEubcAl|Po}f@x_b@umo@xaJ_zQ`a@ozj@plA}pyBqvLsbt@ozBclLjpJs_U|uMe{`AowFgvt@eL_io@isDq}{@lyDedNmvJwkJgiKuyLieQfjCqeI{q@i`H{bMkhP}v^gpSujOc_EiqSaoEupv@atJezbAqz`@{xlAksEcfnAloFyzRivJ}~c@arO{lx@mb@edh@lwEs_r@_yJkdoBqkPqmjC|wIw~yA}Dyjn@jqTull@fe`@}su@tiS{y_ArlQqzd@poLkgDvnKqiXteBqty@s`I_gvAyj@}}wAkmFazeAfGmvsAbaPkzpAfWaa|@puJ}}a@fyAsoo@_sJ{f_A}wAseuAwc@soeBj`WmbbB|gc@_vtAxvOg`f@jcDmso@t|Cc`rAahRgcwAqaJkml@rSku_AS{lqD|Ju}h@syFwv]_nO}ix@gk[at^{vXor`@w`Au_o@wl^gsa@_nSmoVnEo~{AzSkcbD_lKku~@czGu|XesHq`PwvD{{cAi@qvfA{zAuikCpy@}lrCtfIognBz}Dasj@lnP_pDveLsmUsk@uaWpxF}ojAhoDc|_AexAakp@xnE}_dAyy@wc}AmkLaly@}gDorPmuFet\\qfG_x|@ebFmdhBd`Bisb@gpIwnp@svO_|b@wqEagg@rjBcb{AwpB_knBkR_jq@pwKygj@liL{mi@zvCapdB~H}arAx~N_p{@jo^qcqB~xB}tcAieKwldA`aTc}yAdnHahcCpoWqv[qxHg~c@ksEkbqAhpA}swA}HifwBlfGi`a@|hAgot@lyJehj@zdLghh@ppF_q`@y}Jip]p_Mihf@ulP}_u@ujDstnAtRys]`~HanU|n@}oo@_]qan@gcBwyi@}bIkyyAh}@qxi@vzIgeQp|D}~SpiAwvKdlGy}E_Hqme@duEmta@|]aqm@zwWwfr@jhH}~i@jhFgaI"
            },
            "summary": "I-80 E",
            "warnings": [],
            "waypoint_order": []
...
```
GET https://maps.googleapis.com/maps/api/distancematrix/json?origins=place_id:ChIJRRI8walZwokRCPoUQ0TSCoQ&destinations=place_id:ChIJb8Jg9pZYwokR-qHGtvSkLzs&key=AIzaSyB_qbjwcLagyna7J6zK7Y3s0NErk90I360
```
```
{
...
```
GET https://maps.googleapis.com/maps/api/distancematrix/json?origins=place_id:ChIJA-2qKIt9hYARZ5N1NdUVtHE&destinations=place_id:ChIJCSF8lBZEwokRhngABHRcdoI&key=AIzaSyB_qbjwcLagyna7J6zK7Y3s0NErk90I360
```
```
{
    "destination_addresses": [
